package DrawSocket.DrawSocketServer;

import DrawSocket.DrawShared.DrawSocketMessage;
import DrawSocket.DrawShared.DrawSocketMessageOperation;
...
@ServerEndpoint(value="/drawer/")
public class DrawSocketServer {
